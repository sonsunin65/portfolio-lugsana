                ...
                <div className="mt-6 space-y-4">
                  <div className="mt-6 space-y-4">
                    <p className="text-muted-foreground leading-relaxed">
                      สวัสดีค่ะ เป็นครูที่รักการสอนและมีความสุขกับการได้เห็นนักเรียนเติบโตและพัฒนา
                      เชื่อว่าการเรียนรู้ที่ดีเกิดจากบรรยากาศที่อบอุ่น เป็นกันเอง และเต็มไปด้วยความสนุกสนาน
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      นอกจากการสอนในห้องเรียน ยังจัดกิจกรรมต่างๆ เพื่อส่งเสริมให้นักเรียนได้เรียนรู้
